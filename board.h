...
class board{
 public:
  ...
  bool sanitize_input(int x, int y); //Return true if user input is valid.
  void castling(int x, int y); // Handle castling
  void move(int x, int y); // Check if a movement is valid. If it is, update board and change turn.
